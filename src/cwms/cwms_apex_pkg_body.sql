...
BEGIN
    ...
    CASE f_file_type
     ...
     WHEN 2 THEN
        ...
        CASE  
         WHEN f_header_loc = 2 AND temp_header_val = 'LOCATION LEVEL' THEN
          temp_var := c_app_logic_yes;
         WHEN f_header_loc = 3 AND temp_header_val = 'CONSTANT LEVEL' THEN
          temp_var := c_app_logic_yes;
         WHEN f_header_loc = 4 AND temp_header_val = 'UNIT' THEN
          temp_var := c_app_logic_yes;
         WHEN f_header_loc = 5 AND temp_header_val = 'CALENDAR OFFSET' THEN
          temp_var := c_app_logic_yes;
         WHEN f_header_loc = 6 AND temp_header_val = 'TIME OFFSET' THEN
          temp_var := c_app_logic_yes;
         WHEN f_header_loc = 7 AND temp_header_val = 'SEASONAL VALUE' THEN
          temp_var := c_app_logic_yes;
         WHEN f_header_loc = 8 AND temp_header_val = 'OFFICE' THEN
          temp_var := c_app_logic_yes;
        ELSE
          temp_var := c_app_logic_no;
