...
(
  ...
  BANK                    VARCHAR2(1),
  GAGE_ZERO_ELEVATION     BINARY_DOUBLE,
...
ALTER TABLE AT_GAGE ADD CONSTRAINT AT_GAGE_PK  PRIMARY KEY (GAGE_LOCATION_CODE) USING INDEX;
...
COMMENT ON COLUMN AT_GAGE_SENSOR.GAGE_LOCATION_CODE IS 'Reference to gage location.';
COMMENT ON COLUMN AT_GAGE_SENSOR.SENSOR_ID          IS 'Name of sensor.';
COMMENT ON COLUMN AT_GAGE_SENSOR.PARAMETER_CODE     IS 'Parameter for sensor.';
COMMENT ON COLUMN AT_GAGE_SENSOR.VALID_RANGE_MIN    IS 'Lowest valid value for sensor.';
COMMENT ON COLUMN AT_GAGE_SENSOR.VALID_RANGE_MAX    IS 'Highest valid value for sensor.';
COMMENT ON COLUMN AT_GAGE_SENSOR.COMMENTS           IS 'Additional comments for sensor.';

ALTER TABLE AT_GAGE_SENSOR ADD CONSTRAINT AT_GAGE_SENSOR_PK  PRIMARY KEY (GAGE_LOCATION_CODE, SENSOR_ID);
ALTER TABLE AT_GAGE_SENSOR ADD CONSTRAINT AT_GAGE_SENSOR_FK1 FOREIGN KEY (GAGE_LOCATION_CODE) REFERENCES AT_GAGE (GAGE_LOCATION_CODE);
...
(
   GOES_LOCATION_CODE       NUMBER(10)  NOT NULL,
...
COMMENT ON COLUMN AT_GOES.GOES_LOCATION_CODE       IS 'References location.';
...
ALTER TABLE AT_GOES ADD CONSTRAINT AT_GOES_PK  PRIMARY KEY (GOES_LOCATION_CODE) USING INDEX;
ALTER TABLE AT_GOES ADD CONSTRAINT AT_GOES_CK1 CHECK (GOES_SATELLITE = 'E' OR GOES_SATELLITE = 'W');
ALTER TABLE AT_GOES ADD CONSTRAINT AT_GOES_FK1 FOREIGN KEY (GOES_LOCATION_CODE) REFERENCES AT_PHYSICAL_LOCATION (LOCATION_CODE); 
