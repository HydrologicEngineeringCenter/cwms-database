...
ALTER TABLE AT_LOCATION_LEVEL ADD CONSTRAINT AT_LOCATION_LEVEL_U1  UNIQUE (LOCATION_CODE, SPECIFIED_LEVEL_CODE, PARAMETER_CODE, DURATION_CODE, ATTRIBUTE_PARAMETER_CODE,LOCATION_LEVEL_DATE) USING INDEX;
...
ALTER TABLE AT_LOCATION_LEVEL ADD CONSTRAINT AT_LOCATION_LEVEL_CK6 CHECK (NOT (ATTRIBUTE_VALUE IS NOT NULL AND ATTRIBUTE_PARAMETER_CODE IS NULL));
