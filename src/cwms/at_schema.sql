...
ALTER TABLE AT_GEOGRAPHIC_LOCATION ADD CONSTRAINT AT_GEOGRAPHIC_LOCATION_PK  PRIMARY KEY (LOCATION_CODE, GEOGRAPHIC_ID) USING INDEX;
...
ALTER TABLE AT_STREAM ADD CONSTRAINT AT_STREAM_PK  PRIMARY KEY (STREAM_LOCATION_CODE) USING INDEX;
...
ALTER TABLE AT_STREAM_REACH ADD CONSTRAINT AT_STREAM_REACH_PK  PRIMARY KEY (STREAM_LOCATION_CODE, UPSTREAM_STATION, DOWNSTREAM_STATION) USING INDEX;
...
ALTER TABLE AT_STREAM_LOCATION ADD CONSTRAINT AT_STREAM_LOCATION_PK  PRIMARY KEY (LOCATION_CODE, STREAM_LOCATION_CODE) USING INDEX;
...
ALTER TABLE AT_BASIN ADD CONSTRAINT AT_BASIN_PK  PRIMARY KEY (BASIN_LOCATION_CODE) USING INDEX;
...
ALTER TABLE AT_GAGE ADD CONSTRAINT AT_GAGE_PK  PRIMARY KEY (GAGE_CODE) USING INDEX;
...
ALTER TABLE AT_GAGE_SENSOR ADD CONSTRAINT AT_GAGE_SENSOR_PK  PRIMARY KEY (GAGE_CODE, SENSOR_ID);
...
ALTER TABLE AT_GOES ADD CONSTRAINT AT_GOES_PK  PRIMARY KEY (GAGE_CODE) USING INDEX;
...
ALTER TABLE AT_DISPLAY_SCALE ADD CONSTRAINT AT_DISPLAY_SCALE_PK  PRIMARY KEY (LOCATION_CODE, PARAMETER_CODE, UNIT_CODE) USING INDEX;
...
ALTER TABLE AT_LOC_LVL_INDICATOR ADD CONSTRAINT AT_LOC_LVL_INDICATOR_PK  PRIMARY KEY (LEVEL_INDICATOR_CODE) USING INDEX;
...
ALTER TABLE AT_LOC_LVL_INDICATOR ADD CONSTRAINT AT_LOC_LVL_INDICATOR_U1  UNIQUE (
   LOCATION_CODE,
   SPECIFIED_LEVEL_CODE,
   PARAMETER_CODE,
   DURATION_CODE,
...
ALTER TABLE AT_LOC_LVL_INDICATOR_COND ADD CONSTRAINT AT_LOC_LVL_INDICATOR_COND_PK  PRIMARY KEY (LEVEL_INDICATOR_CODE, LEVEL_INDICATOR_VALUE) USING INDEX;
...
ALTER TABLE AT_FORECAST_SPEC ADD CONSTRAINT AT_FORECAST_SPEC_PK  PRIMARY KEY (FORECAST_SPEC_CODE) USING INDEX;
ALTER TABLE AT_FORECAST_SPEC ADD CONSTRAINT AT_FORECAST_SPEC_U1  UNIQUE (TARGET_LOCATION_CODE, FORECAST_ID);
...
ALTER TABLE AT_FORECAST_TS ADD CONSTRAINT AT_FORECAST_TS_PK  PRIMARY KEY (FORECAST_SPEC_CODE, TS_CODE, FORECAST_DATE, ISSUE_DATE);
...
/
create unique index at_blob_u1 on at_blob(office_code, upper(id))
/
...
/
create index at_tsv_std_text_idx1 on at_tsv_std_text(data_entry_date)
/
...
/
create index at_tsv_text_idx1 on at_tsv_text(data_entry_date)
/
...
/
create index at_tsv_binary_idx1 on at_tsv_binary(data_entry_date)
/
