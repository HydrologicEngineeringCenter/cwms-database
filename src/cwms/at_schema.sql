...
ALTER TABLE AT_SHEF_DECODE ADD (
 ...
 FOREIGN KEY (LOCATION_CODE, LOC_GROUP_CODE) 
 REFERENCES AT_LOC_GROUP_ASSIGNMENT (LOCATION_CODE,LOC_GROUP_CODE))
/

ALTER TABLE AT_SHEF_DECODE ADD (
  CONSTRAINT AT_SHEF_DECODE_R04 
 FOREIGN KEY (SHEF_DURATION_CODE) 
 REFERENCES CWMS_SHEF_DURATION (SHEF_DURATION_CODE) DISABLE)
/
