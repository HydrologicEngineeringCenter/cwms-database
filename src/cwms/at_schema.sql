...
(
   ...
   SOURCE_LOCATION_CODE NUMBER(10)   NOT NULL,
...
COMMENT ON COLUMN AT_FORECAST.TARGET_LOCATION_CODE IS 'References location.';
COMMENT ON COLUMN AT_FORECAST.SOURCE_LOCATION_CODE IS 'Reference to location that is the source of forecats for this location.';
...
COMMENT ON COLUMN AT_FORECAST.MAX_AGE              IS 'Age of existing forecast in hours before a new forecast is considered missing.';

ALTER TABLE AT_FORECAST ADD CONSTRAINT AT_FORECAST_PK  PRIMARY KEY (TARGET_LOCATION_CODE) USING INDEX;
ALTER TABLE AT_FORECAST ADD CONSTRAINT AT_FORECAST_CK1 CHECK (SOURCE_AGENCY = 'USACE' OR SOURCE_AGENCY = 'NWS');
ALTER TABLE AT_FORECAST ADD CONSTRAINT AT_FORECAST_CK2 CHECK (UPPER(TRIM(SOURCE_OFFICE)) = SOURCE_OFFICE);
ALTER TABLE AT_FORECAST ADD CONSTRAINT AT_FORECAST_CK3 CHECK (UPPER(TRIM(FORECAST_TYPE)) = FORECAST_TYPE);
ALTER TABLE AT_FORECAST ADD CONSTRAINT AT_FORECAST_FK1 FOREIGN KEY (TARGET_LOCATION_CODE) REFERENCES AT_PHYSICAL_LOCATION (LOCATION_CODE);  
ALTER TABLE AT_FORECAST ADD CONSTRAINT AT_FORECAST_FK2 FOREIGN KEY (SOURCE_LOCATION_CODE) REFERENCES AT_PHYSICAL_LOCATION (LOCATION_CODE);  
