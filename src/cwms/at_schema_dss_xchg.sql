...
ALTER TABLE AT_XCHG_DATASTORE_DSS ADD CONSTRAINT AT_XCHG_DATASTORE_DSS_PK  PRIMARY KEY (DATASTORE_CODE) USING INDEX;
ALTER TABLE AT_XCHG_DATASTORE_DSS ADD CONSTRAINT AT_XCHG_DATASTORE_DSS_UK1 UNIQUE (OFFICE_CODE, DATASTORE_ID) USING INDEX;
...
ALTER TABLE AT_XCHG_SET ADD CONSTRAINT AT_XCHG_SET_PK  PRIMARY KEY (XCHG_SET_CODE) USING INDEX; 
ALTER TABLE AT_XCHG_SET ADD CONSTRAINT AT_XCHG_SET_U1  UNIQUE (OFFICE_CODE, XCHG_SET_ID) USING INDEX;
...
ALTER TABLE AT_XCHG_DSS_TS_MAPPINGS ADD CONSTRAINT AT_XCHG_DSS_TS_MAPPINGS_PK  PRIMARY KEY (MAPPING_CODE, XCHG_SET_CODE, CWMS_TS_CODE) USING INDEX;
ALTER TABLE AT_XCHG_DSS_TS_MAPPINGS ADD CONSTRAINT AT_XCHG_DSS_TS_MAPPINGS_U1  UNIQUE (XCHG_SET_CODE, CWMS_TS_CODE) USING INDEX;
