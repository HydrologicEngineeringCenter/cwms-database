...
--    rating. Although this parameter is a str_tab_t, only one independent 
...
-- p_independent_ids
--    The independent time series to be reverse rated with the specified 
--    rating and stored. Although this parameter is a str_tab_t, only one 
--    independent parameter can be specified.
--
-- p_dependent_id
