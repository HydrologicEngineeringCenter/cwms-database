...
select tsx.ts_code,
       ...
       cwms_util.convert_units(tsx.least_accepted_value, tid.unit_id, cwms_util.get_default_units(tid.parameter_id, 'EN')) as least_acceptedvalue_en, 
       ...
       cwms_util.convert_units(tsx.greatest_accepted_value, tid.unit_id, cwms_util.get_default_units(tid.parameter_id, 'EN')) as greatest_acceptedvalue_en, 
