...
delete from at_clob where office_code = 53 and id = '/VIEWDOCS/AV_TS_PROFILE_INST_TSV';
insert into at_clob values (cwms_seq.nextval, 53, '/VIEWDOCS/AV_TS_PROFILE_INST_TSV', null,
'
/**
