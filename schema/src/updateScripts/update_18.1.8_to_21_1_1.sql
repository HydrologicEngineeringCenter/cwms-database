...
define logfile=update_&db_name._18_1_8_to_21_1_1.log
...
@@./21_1_1/verify_db_version
prompt ################################################################################
prompt UPDATING AT_PHYSICAL_LOCATION Trigger
@./21_1_1/update_at_physical_location_triggers
prompt Insert Probability parameter
@./21_1_1/insertProbability
prompt Drop AT_SEC_DB_TABLE
@./21_1_1/dropAtSecDbiTable
prompt add yearly tables
@./21_1_1/add_yearly_tables
