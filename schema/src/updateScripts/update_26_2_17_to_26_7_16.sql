...
ALTER PACKAGE cwms_util COMPILE BODY;
ALTER PACKAGE cwms_loc COMPILE BODY;
ALTER TRIGGER AT_LOCATION_GEOMETRY_T01 COMPILE;
...
/*
This code is erroring out.  Column has to be empty to change from integer to number(14)
PROMPT ################################################################################
...
/*
This code is erroring out. Column has to be empty to change from TIMESTAMP(6) to TIMESTAMP(3)
PROMPT ################################################################################
