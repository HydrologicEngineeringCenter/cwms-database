...
define logfile=update_&db_name._22_1_1_to_22_1_2.log
...
drop index at_screening_id_uc01;
alter table at_screening_id modify screening_id varchar2(256);
create unique index at_screening_id_uc01 on at_screening_id (db_office_code, upper(screening_id), base_parameter_code);
