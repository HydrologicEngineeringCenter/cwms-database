...
define logfile=update_&db_name._issue_110.log
...
drop package cwms_forecast;

drop view av_forecast;
drop view av_forecast_ex;
drop view av_forecast_spec;


drop table at_forecast_text;
drop table at_forecast_ts;
drop table at_forecast_spec;

drop public synonym cwms_forecast;
drop public synonym cwms_v_forecast;
drop public synonym cwms_v_forecast_ex;
drop public synonym cwms_v_forecast_spec;

delete
  from at_clob
 where id in ('/VIEWDOCS/AV_FORECAST',
              '/VIEWDOCS/AV_FORECAST_EX',
              '/VIEWDOCS/AV_FORECAST_SPEC'
             );
