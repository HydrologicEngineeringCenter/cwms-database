...
--------------------------------------------------------------------------------
   ...
   begin
      clear_caches;
      cwms_ts.delete_ts_group(p_ts_category_id => 'Default', p_ts_group_id => c_location_id, p_db_office_id => c_district_office_id);
      cwms_ts.delete_ts_group(p_ts_category_id => c_temp_air, p_ts_group_id =>  c_location_id, p_db_office_id => c_district_office_id);
      cwms_ts.delete_ts_group(p_ts_category_id => c_rdl_aliases, p_ts_group_id => c_reporting, p_db_office_id => c_district_office_id);
