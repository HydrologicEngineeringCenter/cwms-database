...
GRANT EXECUTE ON &cwms_schema..test_cwms_loc_normal_user to &1;
...
GRANT EXECUTE ON &cwms_schema..test_cwms_text to &1;
...
GRANT EXECUTE on &cwms_schema..test_cwms_loc_normal_user to &7;
