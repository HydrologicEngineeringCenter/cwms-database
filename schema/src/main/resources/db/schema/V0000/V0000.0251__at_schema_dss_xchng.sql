...
(
  DATASTORE_CODE  NUMBER(14)         NOT NULL,
...
(
  XCHG_SET_CODE      NUMBER(14)                 NOT NULL,
  DATASTORE_CODE     NUMBER(14)                 NOT NULL,
  OFFICE_CODE        NUMBER(14)                 NOT NULL,
  ...
  INTERPOLATE_COUNT  NUMBER(14)                 DEFAULT 0,
...
(
  MAPPING_CODE            NUMBER(14)    NOT NULL,
  XCHG_SET_CODE           NUMBER(14)    NOT NULL,
  CWMS_TS_CODE            NUMBER(14)    NOT NULL,
