             ...
             from (select o.office_id,
                   ...
                   select o.office_id,
                    ...
                    where ts2.ts_code = ts.ts_code
                      ...
                      and d2.duration_code = ll.duration_code
                  ) lvl
              --
             join (select lli.level_indicator_code,
                ...
                and extract(day from ind.maximum_age) * 1440 + extract(hour from ind.maximum_age) * 60 + extract(minute from ind.maximum_age)  >= lvl.interval
                ...
                and nvl((to_char(ind.attribute_parameter_type_code)), '@') =
                       nvl((to_char(lvl.attribute_parameter_type_code)), '@')
