...
as
   select o.office_id,
          ...
          b.sort_order,
          to_number(nvl(cwms_util.eval_rpn_expression(cu.function, double_tab_t(b.total_drainage_area)), b.total_drainage_area)) as total_drainange_area,
          to_number(nvl(cwms_util.eval_rpn_expression(cu.function, double_tab_t(b.contributing_drainage_area)), b.contributing_drainage_area)) as contributing_drainage_area,
