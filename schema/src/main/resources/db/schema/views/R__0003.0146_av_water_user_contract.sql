...
select office_id,
  ...
  from (select o.office_id,
               ...
               nvl(cwms_util.eval_rpn_expression(uc.function, double_tab_t(wc.contracted_storage)), wc.contracted_storage) as contracted_storage,
               ...
               nvl(cwms_util.eval_rpn_expression(uc.function, double_tab_t(wc.initial_use_allocation)), wc.initial_use_allocation) as initial_use_allocation,
               nvl(cwms_util.eval_rpn_expression(uc.function, double_tab_t(wc.future_use_allocation)), wc.future_use_allocation) as future_use_allocation,
