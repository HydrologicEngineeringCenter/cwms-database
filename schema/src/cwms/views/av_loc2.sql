 ...
 * @field geometry             Geometry of location (point, polygon, etc)
 * @field geometry_type        Type of geometry (1..7 = point,line,polygon,collection,multipoint,multiline,multipolygon)
 */
');
...
as
   select q1.location_code,
          ...
          nvl (decode(q4.geometry_type_code, 1,'POINT', 2,'LINE', 3,'POLYGON', 4,'COLLECTION', 5,'MULTIPOINT', 6,'MULTILINE', 7,'MULTIPOLYGON'),
               decode(q5.geometry_type_code, 1,'POINT', 2,'LINE', 3,'POLYGON', 4,'COLLECTION', 5,'MULTIPOINT', 6,'MULTILINE', 7,'MULTIPOLYGON')) as geometry_type
     from (------------------------------------
          ...
          (---------------------------------------------------
           ...
           select q41.location_code,
             ...
             from (-----------------------------
                  ...
                  ) q41a on q41a.location_code = q41.location_code
                  left outer join
                  (---------------
                   -- time zone --
                   ---------------
           ...
           select q51.location_code,
             ...
             from (-----------------------------
                  ...
                  (select location_code,
                          ...
                          longitude
                     from at_location_geometry
                  ) q51a on q51a.location_code = q51.location_code
                  left outer join
                  (---------------
                   -- time zone --
                   ---------------
