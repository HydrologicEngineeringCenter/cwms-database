...
select q1.office_id,
       ...
       cwms_util.change_timezone(q1.location_level_date, 'UTC', nvl(cwms_loc.get_local_timezone(q1.location_code), 'UTC')) as effective_date_local,
       nvl(cwms_loc.get_local_timezone(q1.location_code), 'UTC') as local_time_zone,
       q1.expiration_date as expiration_date_utc,
       cwms_util.change_timezone(q1.expiration_date, 'UTC', nvl(cwms_loc.get_local_timezone(q1.location_code), 'UTC')) as expiration_date_local,
       q1.location_id,
       q1.parameter_id,
