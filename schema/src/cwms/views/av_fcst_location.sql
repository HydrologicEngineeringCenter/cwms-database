 ...
 * @field sort_order      The sort order of the location for this specification. -1 means primary.
 * @field is_primary      ''T'' if this is the primary location, else ''F''
...
select o.office_id,
       ...
       fl.sort_order,
       case fl.sort_order when -1 then 'T' else 'F' end as is_primary,
       o.office_code,
       fs.fcst_spec_code,
       fl.location_code
