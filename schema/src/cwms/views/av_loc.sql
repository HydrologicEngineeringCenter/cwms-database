 ...
 * @field geometry_type        Type of geometry (POINT,LINE,POLYGON,COLLECTION,MULTIPOINT,MULTILINE,MULTIPOLYGON)
 */
');
...
( with phy_loc as
  ( select loc.location_code,
           ...
           nvl (ll.longitude,         bll.longitude)        as longitude,
           nvl (ll.latitude,          bll.latitude)         as latitude,
           ...
           nvl (nvl (loc.county_code, bas.county_code), 0)  as county_code,         
           loc.public_name,
           loc.long_name,
           loc.description,
           loc.location_kind,
           ...
           nvl (nvl (loc.office_code, bas.office_code), 0)        as office_code,
